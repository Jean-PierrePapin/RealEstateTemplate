      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card listing-preview">
            <img class="card-img-top" src="wp-content/themes/btre_theme/assets/img/homes/home-1.jpg" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card listing-preview">
            <img class="card-img-top" src="wp-content/themes/btre_theme/assets/img/homes/home-2.jpg" alt="">
            <div class="card-img-overlay">
              <h2>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card listing-preview">
            <img class="card-img-top" src="wp-content/themes/btre_theme/assets/img/homes/home-3.jpg" alt="">
            <div class="card-img-overlay">
              <h2>
